...
class AutocompleteAccount(object):
    ...
    def __init__(self, currency_code=None, currency_decimal_places=None, currency_id=None, currency_symbol=None, id=None, name=None, name_with_balance=None, type=None):  # noqa: E501
